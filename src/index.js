export default grapesjs.plugins.add('gjs-preset-newsletter', (editor, opts) => {
  ...
  let defaults = {
    ...
    sect100BlkLabel: c.sect100BlkLabel || '1 Section',
    sect50BlkLabel: c.sect50BlkLabel || '1/2 Section',
    sect30BlkLabel: c.sect30BlkLabel || '1/3 Section',
    sect37BlkLabel: c.sect37BlkLabel || '3/7 Section',
    buttonBlkLabel: c.buttonBlkLabel || 'Button',
    dividerBlkLabel: c.dividerBlkLabel || 'Divider',
    textBlkLabel: c.textBlkLabel || 'Text',
    textSectionBlkLabel: c.textSectionBlkLabel || 'Text Section',
    imageBlkLabel: c.imageBlkLabel || 'Image',
    quoteBlkLabel: c.quoteBlkLabel || 'Quote',
    linkBlkLabel: c.linkBlkLabel || 'Link',
    linkBlockBlkLabel: c.linkBlockBlkLabel || 'Link Block',
    gridItemsBlkLabel: c.gridItemsBlkLabel || 'Grid Items',
    listItemsBlkLabel: c.listItemsBlkLabel || 'List Items',
    assetsModalTitle: c.assetsModalTitle || 'Select image',
    styleManagerSectors: c.styleManagerSectors || [{
      name: 'Dimension',
      open: true,
